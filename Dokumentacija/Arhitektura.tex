...
\end{figure}
		...
		Na slici 4.6 prikazan je dijagram razreda cijele aplikacije, i naglasak je najviše na ovisnostima među slojevima.
		...
		\eject
				...
				\end{figure}	
							...
							\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth,keepaspectratio]{13 aplikacija.png}
					\caption{Dijagram razreda - cjelokupna aplikacija}
				\end{figure}	
