...
Naša baza podataka sastoji se od deset entiteta:
\begin{multicols}{3}
  \begin{itemize}
    \item Account  \item Event \item Thread \item Post
    \item District \item Street \item Home \item[\vspace{\fill}]
    \item Role \item RoleRequest \item Meeting \item[\vspace{\fill}]
  \end{itemize}
\end{multicols}
