	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Administrator
						\item  \textbf{Cilj:} Pregledati listu kvartova
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjeti:}
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik biva preusmjeren na stranicu gdje vidi popis kvartova
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[3.a] Korisnik unese ime četvrti koje je već zauzeto, ili ime ulice koje je već zauzeto, ili za četvrt ne definira niti jednu ulicu, ili za ulicu ne definira raspon brojeva, ili za ulicu definira mogućnost postojanja negativnih brojeva
							\item[] \begin{packed_enum}
