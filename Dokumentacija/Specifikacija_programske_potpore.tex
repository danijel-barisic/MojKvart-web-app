	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC24 - Otvaranje teme na forumu vezane za izvješće s "Vijeća četvrti"}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC25 - Podnošenje zahtjeva za dodjelu uloge}}
					\begin{packed_item}
