	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Administrator
						\item  \textbf{Cilj:} Pregledati podatke o odabranom kvartu
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjeti:}
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik dobiva prikaz informacija o odabranom kvartu
						\end{packed_enum}
				...
				\begin{packed_item}					
					...
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{01 dijagram obrazaca uporabe 1.png}
					\caption{Dijagram obrazaca uporabe, osnovne funkcionalnosti}
					\end{figure}
					
					\item[] \begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{02 dijagram obrazaca uporabe 2.png}
					\caption{Dijagram obrazaca uporabe, funkcionalnosti upravljanja osobnim podacima}
					\end{figure}
					
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{03 dijagram obrazaca uporabe 3.png}
					\caption{Dijagram obrazaca uporabe, funkcionalnosti sekcije događaji}
					\end{figure}
					
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{04 dijagram obrazaca uporabe 4.png}
					\caption{Dijagram obrazaca uporabe, funkcionalnosti sekcije "Forum"}
					\end{figure}
					
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{05 dijagram obrazaca uporabe 5.png}
					\caption{Dijagram obrazaca uporabe, funkcionalnosti sekcije "Vijeće četvrti"}
					\end{figure}
					
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{06 dijagram obrazaca uporabe 6.png}
...
brisanja.  		
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth,keepaspectratio]{07 sekvencijski dijagram 1.png}
		...
		\noindent Korisnik šalje poslužitelju zahtjev za stvaranje uloge, poslužitelj vraća 						prikaz zahtjeva. Nakon ispune zahtjeva poslužitelj traži potvrdu ispune zahtjeva 					te korisnik šalje zahtjev za dodjelu uloge. Poslužitelj pohranjuje 
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth,keepaspectratio]{08 sekvencijski dijagram 2.png}
		...
		\noindent Administrator odabire željenu ulogu, poslužitelj vraća prikaz uloge te 							  administrator šalje zahtjev za dodijelu 
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth,keepaspectratio]{09 sekvencijski dijagram 3.png}
		...
		\noindent Administrator šalje zahtjev poslužitelju za brisanjem kvarta. Poslužitelj 						odgovara sa upozorenjem o trajnosti 
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth,keepaspectratio]{10 sekvencijski dijagram 4.png}
