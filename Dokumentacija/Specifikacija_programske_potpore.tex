	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item komentirati u temama na Forumu
				...
				\begin{packed_enum}
					...
					\item ukloniti objave na forumu	
				\end{packed_enum}
				...
				\begin{packed_enum}
					...
					\item pristupiti svim podacima u bazi podataka (objave na forumima, događanja u četvrtima i slično)	
				\end{packed_enum}
