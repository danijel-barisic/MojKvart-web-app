	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item  \textbf{Cilj:} Dodijeliti ulogu korisniku
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Korisnik je prijavljen u sustav i ima ulogu "Admin"
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire korisnika kojem želi dodijeliti ulogu
							\item Korisnik odabire ulogu koju želi dodijeliti
							\item Baza podataka se ažurira
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Administrator
						\item  \textbf{Cilj:} Oduzeti ulogu korisniku
						\item  \textbf{Sudionici:} Baza podataka
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire korisnika kojem želi oduzeti ulogu
							\item Korisnik odabire ulogu koju želi oduzeti
							\item Baza podataka se ažurira
						\end{packed_enum}
