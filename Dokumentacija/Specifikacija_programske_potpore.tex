\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC21 - Automatsko brisanje teme na "Forumu"}}
                    \begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Pregled cjeline "Vijeće četvrti" }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Prikaz izvješća u "Vijeću četvrti" }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - Objava novog izvješća na "Vijeću četvrti"}}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC25 - Uređivanje izvješća na "Vijeću četvrti"}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Brisanje izvješća s "Vijeća četvrti"}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC27 - Otvaranje teme na "Forumu" vezanu za izvješće s "Vijeća četvrti"}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC28 - Podnošenje zahtjeva za dodjelu uloge}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC29 - Pristup svim korisnicima u sustavu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC30 - Pregled korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC31 - Dodjela uloge}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC32 - Oduzimanje uloge}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC33 - Automatsko razrješavanje zahtjeva za ulogu kod manualne dodjele uloge korisniku}}
                    \begin{packed_item}
					...
					\noindent \underbar{\textbf{UC34 - Pregled zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC35 - Prihvaćanje zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC36 - Odbijanje zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC37 - Pregled blokiranih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC38 - Blokiranje korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC39 - Deblokiranje korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC40 - Brisanje korisničkog računa drugog korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC41 - Pregled popisa kvartova}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC42 - Pregled kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC43 - Definiranje kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC44 - Uređivanje kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC45 - Brisanje kvarta}}
					\begin{packed_item}
