				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire opciju pregleda osobnih podataka (UC3)
					...
					\noindent \underbar{\textbf{UC6 - Pregled događaja u cjelini "Događaji" }}
					\begin{packed_item}
						...
						\end{packed_item}
					\noindent \underbar{\textbf{UC7 - Stvaranje prijedloga događaja}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC12 - Pregled tema na forumu}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC14 - Odabir objave za odgovor }}
					\begin{packed_item}
					...
					\end{packed_item}	
					\noindent \underbar{\textbf{UC16 - Objava odgovora }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Brisanje odgovora }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC18 - Pregled cjeline "Vijeće četvrti" }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC19 - Stvaranje novog izvješća }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC20 - Uređivanje izvješća }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Objava izvješća }}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC22 - Otvaranje teme na forumu vezane za izvješće s "Vijeća četvrti"}}
					\begin{packed_item}
