\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC33 - Pregled zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC34 - Prihvaćanje zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC35 - Odbijanje zahtjeva za ulogu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC36 - Pregled blokiranih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC37 - Blokiranje korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC38 - Deblokiranje korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC39 - Brisanje korisničkog računa drugog korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC40 - Pregled popisa kvartova}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC41 - Pregled kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC42 - Definiranje kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC43 - Uređivanje kvarta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC44 - Brisanje kvarta}}
					\begin{packed_item}
