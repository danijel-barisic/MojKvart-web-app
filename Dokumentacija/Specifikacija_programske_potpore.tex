			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava temu na "Forumu" (UC15)
							\item Korisnik odabire odgovor čiji autor je on
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC21 - Stvaranje novog izvješća }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC22 - Uređivanje izvješća }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Objava izvješća }}
					\begin{packed_item}
