	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava događaje (UC9)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Moderator"
							\item Korisnik pregledava prijedloge događaja (UC11)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava "Forum" (UC15)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava temu na "Forumu" (UC16)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
                    ...
                    \begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik je upravo obrisao odgovor u temi na "Forumu" (UC20)
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava "Vijeće četvrti" (UC23)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik pregledava izvješće s "Vijeća četvrti" (UC24)
							\item Korisnik ima ulogu "Vijećnik"
					...
					\noindent \underbar{\textbf{UC30 - Pregled svih korisnika u sustavu}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik pregledava sve korisnike u sustavu (UC30)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik pregledava osobne podatke objekta (UC31)
                    ...
                    \begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik je upravo objektu dodijelio ulogu (UC32)
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik pregledava zahtjeve uloga (UC35)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik pregledava popis kvartova (UC42)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik pregledava podatke o kvartu (UC43)
						\end{packed_enum}
						\item  \textbf{Opis osnovnog tijeka:}
                    ...
                    \begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
							\item Korisnik ima ulogu "Administrator"
							\item Korisnik je promijenio podatke o kvartu (UC45) ili obrisao kvart (UC46)
