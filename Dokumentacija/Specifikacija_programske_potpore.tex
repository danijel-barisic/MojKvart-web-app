\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC16 - Odabir objave za odgovor u temi na "Forumu"}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Korisnik
						\item  \textbf{Cilj:} Odabir objave na koju korisnik želi odgovoriti u temi na "Froumu"
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjeti:}
						\item[] \begin{packed_enum}
							\item Korisnik je prijavljen u sustav
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC17 - Uređivanje odgovora }}
					\begin{packed_item}
					...
					\end{packed_item}	
					\noindent \underbar{\textbf{UC18 - Objava odgovora }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Brisanje odgovora }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC22 - Stvaranje novog izvješća }}
					\begin{packed_item}
					...
					\end{packed_item}					
					\noindent \underbar{\textbf{UC23 - Uređivanje izvješća }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - Objava izvješća }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Otvaranje teme na forumu vezane za izvješće s "Vijeća četvrti"}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC28 - Pristup svim korisnicima u sustavu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC39 - Pregled liste četvrti}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC40 - Pregled četvrti}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC41 - Definiranje četvrti}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC42 - Uređivanje četvrti}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC43 - Brisanje četvrti}}
					\begin{packed_item}
